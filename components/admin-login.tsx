    ...
    <div className="flex min-h-[min(520px,70vh)] w-full flex-col items-center justify-center px-4 py-16">
      <div className="glass-panel w-full max-w-md rounded-3xl px-8 py-10 shadow-lg">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-300/85 to-teal-200/85 text-2xl shadow-inner">
            🌸
          </div>
          <h1 className="font-display text-2xl text-stone-950">后台登录</h1>
        ...
        <form onSubmit={submit} className="space-y-5">
          ...
          {error && (
            <p
              role="alert"
              className="rounded-lg bg-stone-100/80 px-3 py-2 text-sm text-stone-900"
            >
              {error}
            </p>
          )}
